...
<html>
    <head>
    <meta http-equiv="Refresh" content="3; url='whatsapp_joining_form.html'" />
        <style>
        .error {color: #FF0000;}
        p 
        {
...
$name = $email =$phone_no= $whatsapp_no= $comments="";
...
{   
    ...
    {
      $whatsapp_noErr = "Whatsapp no. is required";
    } 
    else 
    {
      ...
      {
        $whatsapp_noErr = "Only numbers allowed";
        echo $whatsapp_noErr;
      }
    }
  ...
  $query = "INSERT INTO whatsapp_joining_form VALUES('$name','$email','$phone_no','$whatsapp_no','$comments')";
